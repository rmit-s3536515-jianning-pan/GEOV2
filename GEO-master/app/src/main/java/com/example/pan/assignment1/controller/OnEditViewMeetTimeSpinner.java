...
public class OnEditViewMeetTimeSpinner implements AdapterView.OnItemSelectedListener {


    private String trackingId;
    public OnEditViewMeetTimeSpinner(String id){
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        for (Tracking t : TrackingManager.getTrackingList()) {
            ...
            if (t.getTrackingId().equals(trackingId)) {
                ...
                try {
                    t.setMeetTime(TrackingManager.dateformat.parse(selected));
