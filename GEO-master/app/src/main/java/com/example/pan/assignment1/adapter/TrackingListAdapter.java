...
//        viewHolder.view.setOnClickListener(new onTrackingItemClickedListener(context,t.getTitle(),sStartTime,sEndTime,t.getTrackableId(),t.getTrackingId(),meet));  // pass to the edit tracking activity
